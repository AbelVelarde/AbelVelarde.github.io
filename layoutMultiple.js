...
function crearNombreM(e, i){
    ...
    document.getElementById('recetaM'+i).append(nombre);
}
...
function crearCategoriaM(e, i){
    ...
    document.getElementById('recetaM'+i).append(cat);
...
function crearZonaM(e, i){
    ...
    document.getElementById('recetaM'+i).append(zona);
